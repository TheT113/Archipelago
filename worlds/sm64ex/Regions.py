...
def create_regions(world: MultiWorld, player: int):
    ...
    if (world.EnableCoinStars[player].value):
        regBoB.locations.append(SM64Location(player, "Bob-omb Battlefield 100 Coins", location_table["Bob-omb Battlefield 100 Coins"], regBoB))
    ...
    if (world.EnableCoinStars[player].value):
        regWhomp.locations.append(SM64Location(player, "Whomp's Fortress 100 Coins", location_table["Whomp's Fortress 100 Coins"], regWhomp))
    ...
    if (world.EnableCoinStars[player].value):
        regJRB.locations.append(SM64Location(player, "Jolly Roger Bay 100 Coins", location_table["Jolly Roger Bay 100 Coins"], regJRB))
    ...
    if (world.EnableCoinStars[player].value):
        regCCM.locations.append(SM64Location(player, "Cool, Cool Mountain 100 Coins", location_table["Cool, Cool Mountain 100 Coins"], regCCM))
    ...
    if (world.EnableCoinStars[player].value):
        regBBH.locations.append(SM64Location(player, "Big Boo's Haunt 100 Coins", location_table["Big Boo's Haunt 100 Coins"], regBBH))
    world.regions.append(regBBH)

    regCellar = Region("Basement", RegionType.Generic, "Basement", player, world)
    ...
    if (world.EnableCoinStars[player].value):
        regHMC.locations.append(SM64Location(player, "Hazy Maze Cave 100 Coins", location_table["Hazy Maze Cave 100 Coins"], regHMC))
    ...
    if (world.EnableCoinStars[player].value):
        regLLL.locations.append(SM64Location(player, "Lethal Lava Land 100 Coins", location_table["Lethal Lava Land 100 Coins"], regLLL))
    ...
    if (world.EnableCoinStars[player].value):
        regSSL.locations.append(SM64Location(player, "Shifting Sand Land 100 Coins", location_table["Shifting Sand Land 100 Coins"], regSSL))
    ...
    if (world.EnableCoinStars[player].value):
        regDDD.locations.append(SM64Location(player, "Dire, Dire Docks 100 Coins", location_table["Dire, Dire Docks 100 Coins"], regDDD))
    ...
    if (world.EnableCoinStars[player].value):
        regSL.locations.append(SM64Location(player, "Snowman's Land 100 Coins", location_table["Snowman's Land 100 Coins"], regSL))
    ...
    if (world.EnableCoinStars[player].value):
        regWDW.locations.append(SM64Location(player, "Wet-Dry World 100 Coins", location_table["Wet-Dry World 100 Coins"], regWDW))
    ...
    if (world.EnableCoinStars[player].value):
        regTTM.locations.append(SM64Location(player, "Tall, Tall Mountain 100 Coins", location_table["Tall, Tall Mountain 100 Coins"], regTTM))
    ...
    if (world.EnableCoinStars[player].value):
        regTHI.locations.append(SM64Location(player, "Tiny-Huge Island 100 Coins", location_table["Tiny-Huge Island 100 Coins"], regTHI))
    ...
    if (world.EnableCoinStars[player].value):
        regTTC.locations.append(SM64Location(player, "Tick Tock Clock 100 Coins", location_table["Tick Tock Clock 100 Coins"], regTTC))
    ...
    if (world.EnableCoinStars[player].value):
        regRR.locations.append(SM64Location(player, "Rainbow Ride 100 Coins", location_table["Rainbow Ride 100 Coins"], regRR))
